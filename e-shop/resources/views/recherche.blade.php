...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="{{ url('acceuil') }}">Home</a> / Buy, Sale & Rent</span>
    <h2>Buy, Sale & Rent</h2>
</div>
</div>
<!-- banner -->
...
<div class="row">
                ...
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="{{ url('details') }}">Integer sed porta quam</a></h5>
...
<div class="row">
     ...
     <!-- properties -->
      ...
      <div class="properties">
        ...
        <h4><a href="{{ url('details') }}">Royal Inn</a></h4>
        <p class="price">Price: $234,900</p>
        <div class="listing-detail"><span data-toggle="tooltip" data-placement="bottom" data-original-title="Bed Room">5</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Living Room">2</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Parking">2</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Kitchen">1</span> </div>
        <a class="btn btn-primary" href="{{ url('details') }}">View Details</a>
      </div>
      </div>
      <!-- properties -->
      ...
      <div class="properties">
        ...
        <p class="price">Price: $234,900</p>
        <div class="listing-detail"><span data-toggle="tooltip" data-placement="bottom" data-original-title="Bed Room">5</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Living Room">2</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Parking">2</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Kitchen">1</span> </div>
        <a class="btn btn-primary" href="{{ url('acceuil') }}">View Details</a>
      </div>
      </div>
      <!-- properties -->
